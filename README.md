...
# 💻 Tech Stack:
[![My Skills](https://skillicons.dev/icons?i=js,html,css,electron,nodejs,figma,aws,git,github,bash,blender,bots,express,java,firebase,heroku,linux,mysql,nginx,ps,regex,sequelize,unreal,vscode&perline=5&theme=dark)](https://skillicons.dev)
# 📊 GitHub Stats:
